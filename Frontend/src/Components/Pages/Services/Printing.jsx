          ...
          {[
            {
              ...
              description: 'Fast and cost-effective printing for small to medium runs with exceptional quality.',
            },
            {
              title: 'Large Format',
            ...
            },
            {
              ...
              description: 'Business cards, letterheads, and marketing materials that represent your brand.',
            },
            {
              title: 'Custom Solutions',
              description: 'Tailored printing solutions to meet your specific requirements.',
            },
          ].map((service, index) => (
